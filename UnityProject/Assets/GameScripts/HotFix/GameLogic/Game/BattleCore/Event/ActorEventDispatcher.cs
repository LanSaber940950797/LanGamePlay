...
namespace GameLogic.Battle
{
    ...
    public class ActorEventDispatcher : IMemory
    {
        ...
        public void SendEvent(int eventId)
        {
            if (_allEventListenerMap.TryGetValue(eventId, out var listListener))
            {
                ...
                for (int i = 0; i < count; i++)
                {
                    ...
                    Entity owner = listListener[i].Owner;
                    if (owner == null)
                    {
                        continue;
                    }
                    if (listListener[i].Callback is Action<Entity> callBack)
                    {
                        callBack(owner);
                    }
                    else
        ...
        public void SendEvent<TArg1>(int eventId, TArg1 arg1)
        {
            if (_allEventListenerMap.TryGetValue(eventId, out var listListener))
            {
                ...
                for (int i = 0; i < count; i++)
                {
                    ...
                    if (listListener[i].Callback is Action<Entity, TArg1> callBack)
                    {
                        callBack(owner, arg1);
                    }
                    else
        ...
        public void SendEvent<TArg1, TArg2>(int eventId, TArg1 arg1, TArg2 arg2)
        {
            if (_allEventListenerMap.TryGetValue(eventId, out var listListener))
            {
                ...
                for (int i = 0; i < count; i++)
                {
                    ...
                    if (listListener[i].Callback is Action<Entity, TArg1, TArg2> callBack)
                    {
                        callBack(owner, arg1, arg2);
                    }
                    else
                    {
                        Log.Fatal("Invalid event data type: {0}", eventId);
        ...
        public void SendEvent<TArg1, TArg2, TArg3>(int eventId, TArg1 arg1, TArg2 arg2, TArg3 arg3)
        {
            if (_allEventListenerMap.TryGetValue(eventId, out var listListener))
            {
                ...
                for (int i = 0; i < count; i++)
                {
                    ...
                    if (node.Callback is Action<Entity, TArg1, TArg2, TArg3> callBack)
                    {
                        callBack(owner, arg1, arg2, arg3);
                    }
                    else
                    {
                        Log.Fatal("Invalid event data type: {0}", eventId);
        ...
        public void SendEvent<TArg1, TArg2, TArg3, TArg4>(int eventId, TArg1 arg1, TArg2 arg2, TArg3 arg3, TArg4 arg4)
        {
            if (_allEventListenerMap.TryGetValue(eventId, out var listListener))
            {
                ...
                for (int i = 0; i < count; i++)
                {
                    ...
                    if (listListener[i].Callback is Action<Entity,TArg1, TArg2, TArg3, TArg4> callBack)
                    {
                        callBack(owner, arg1, arg2, arg3, arg4);
                    }
                    else
                    {
                        Log.Fatal("Invalid event data type: {0}", eventId);
        ...
        public void AddEventListener(int eventId, Action<Entity> eventCallback, Entity owner)
        {
        ...
        /// <param name="owner">持有者Tag。</param>
        /// <typeparam name="TArg1">事件参数类型1。</typeparam>
        public void AddEventListener<TArg1>(int eventId, Action<Entity, TArg1> eventCallback, Entity owner)
        {
            AddEventListenerImp(eventId, eventCallback, owner);
        }
        ...
        /// <typeparam name="TArg1">事件参数类型1。</typeparam>
        /// <typeparam name="TArg2">事件参数类型2。</typeparam>
        public void AddEventListener<TArg1, TArg2>(int eventId, Action<Entity, TArg1, TArg2> eventCallback, Entity owner)
        {
            AddEventListenerImp(eventId, eventCallback, owner);
        }
        ...
        /// <typeparam name="TArg2">事件参数类型2。</typeparam>
        /// <typeparam name="TArg3">事件参数类型3。</typeparam>
        public void AddEventListener<TArg1, TArg2, TArg3>(int eventId, Action<Entity, TArg1, TArg2, TArg3> eventCallback, Entity owner)
        {
            AddEventListenerImp(eventId, eventCallback, owner);
        }
        ...
        /// <typeparam name="TArg3">事件参数类型3。</typeparam>
        /// <typeparam name="TArg4">事件参数类型4。</typeparam>
        public void AddEventListener<TArg1, TArg2, TArg3, TArg4>(int eventId, Action<Entity, TArg1, TArg2, TArg3, TArg4> eventCallback, Entity owner)
        {
            AddEventListenerImp(eventId, eventCallback, owner);
        }
        ...
        /// <param name="owner">持有者Tag。</param>
        private void AddEventListenerImp(int eventId, Delegate listener, Entity owner)
        {
            if (!_allEventListenerMap.TryGetValue(eventId, out var listListener))
            {
        ...
        /// </summary>
        /// <param name="owner">持有者Tag。</param>
        public void RemoveAllListenerByOwner(Entity owner)
        {
            var itr = _allEventListenerMap.GetEnumerator();
            while (itr.MoveNext())
            {
        ...
        public void RemoveEventListener(int eventId, Action<Entity> eventCallback, Entity owner)
        {
            RemoveEventListenerImp(eventId, eventCallback, owner);
        }
        ...
        public void RemoveEventListener<TArg1>(int eventId, Action<Entity, TArg1> eventCallback,Entity owner)
        {
            RemoveEventListenerImp(eventId, eventCallback, owner);
        }
        ...
        public void RemoveEventListener<TArg1, TArg2>(int eventId, Action<Entity, TArg1, TArg2> eventCallback, Entity owner)
        {
            RemoveEventListenerImp(eventId, eventCallback,owner);
        }
        ...
        public void RemoveEventListener<TArg1, TArg2, TArg3>(int eventId, Action<Entity, TArg1, TArg2, TArg3> eventCallback, Entity owner)
        {
            RemoveEventListenerImp(eventId, eventCallback, owner);
        }
        ...
        public void RemoveEventListener<TArg1, TArg2, TArg3, TArg4>(int eventId, Action<Entity, TArg1, TArg2, TArg3, TArg4> eventCallback, Entity owner)
        {
            RemoveEventListenerImp(eventId, eventCallback, owner);
        }
        ...
        protected void RemoveEventListenerImp(int eventId, Delegate listener, Entity owner)
        {
            if (_allEventListenerMap.TryGetValue(eventId, out var listListener))
            {
                bool isProcessing = _processEventList.Contains(eventId);
                if (!isProcessing)
                {
                    listListener.RemoveAll(node => node.Callback == listener && node.Owner == owner);
                }
                else
                {
                    ...
                    {
                        var node = listListener[i];
                        if (node.Callback == listener && node.Owner == owner)
                        {
                            node.IsDeleted = true;
                            AddDelayDelete(eventId);
                            break;
    ...
    public class EventRegInfo : IMemory
    {
        ...
        public EventRegInfo(Delegate callback, Entity owner)
        {
        ...
        public static EventRegInfo Alloc(Delegate callback, Entity owner)
        {
