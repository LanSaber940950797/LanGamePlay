...
namespace GameLogic
{
    ...
    public class ThirdPersonSystem : MonoBehaviour
    {
        ...
        // public Vector3 GetTargetDirection(Vector3 input)
        // {
        ...
        private void Move()
        {
            ...
            //
            // // move the player
            // var change = targetDirection.normalized * (_speed * Time.deltaTime) +
            ...
            var change = inputDirection.normalized * (_speed * Time.deltaTime) +
                         new Vector3(0.0f, _verticalVelocity, 0.0f) * Time.deltaTime;
            _controller.Move(change);
            // update animator if using character
            if (_hasAnimator)
            {
